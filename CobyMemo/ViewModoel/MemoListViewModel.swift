...
class MemoListViewModel: CommonViewModel {
    ...
    let dataSource: RxTableViewSectionedAnimatedDataSource<MemoSectionModel> = {
        let ds = RxTableViewSectionedAnimatedDataSource<MemoSectionModel>(configureCell: { (dateSource, tableView, indexPath, memo) -> UITableViewCell in
